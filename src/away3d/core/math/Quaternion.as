    ...
    */
    public final class Quaternion
    {
	    ...
	    */
		...
		/**
		 * Creates a new <code>Quaternion</code> object.
		 *
		 * @param	x	[optional]	A default value for the horizontal coordinate of the quaternion object. Defaults to 0.
		 * @param	y	[optional]	A default value for the vertical coordinate of the quaternion object. Defaults to 0.
		 * @param	z	[optional]	A default value for the depth coordinate of the quaternion object. Defaults to 0.
		 * @param angle [optional]	A default value for the angle coordinate of the quaternion object. Defaults to 0.
		 */
        public function Quaternion(x:Number = 0, y:Number = 0, z:Number = 0, angle:Number = 0)
        {
            axis2quaternion(x, y, z, angle);
        }
