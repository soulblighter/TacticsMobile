package julio.tactics.regras.GURPS.Pericias
{
	 ...
	 * @author Júlio Cézar
	 */
	public class PericiaMagicaMD extends Pericia implements IModListaAcoes
	{
		
		public var _idAcao:String;
		
		public function PericiaMagicaMD( id:EPericia, nome:String, descricao:String, idAcao:String )
		{
			super( id, nome, descricao, -5, EAtributo.IQ, -4, 4 );
