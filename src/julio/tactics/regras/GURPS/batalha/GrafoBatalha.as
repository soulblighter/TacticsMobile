...
//		private var _suc:Object;			// Lista de sucessores de cada vertice
//		private var _matriz:Object;			// Matriz
		
//		private var _objetos:Object;		// objetos do cenário
		
		public function GrafoBatalha()
		{
...
//			this._matriz = new Object;
//			this._vertices = new Object;
//			this._suc = new Object;
			
//			this._objetos = new Object;
			
//			for ( var i:uint = 0; i < tamanho; i++ )
//				this._matriz.push( new Array );
			
//			for ( var i2:uint = 0; i2 < tamanho; i2++ )
//				this._matriz[i2] = 0;
		...
		public function criarMapa( x:uint, z:uint ):void
		{
			...
			for ( var a:uint = 0; a < x; a++ )
				for ( var b:uint = 0; b < z; b++ )
					this._tabuleiro.push( new Vertice( a, b ) );
		}
...
//			this._objetos[id].push( tile )
		...
		{
			return this._tabuleiro[pos2id(x, z)].tipo != "void";
...
//			return true;
		...
		public function inserirObjeto( x:uint, z:uint, id:String, o:ObjetoCenario ):void
		{
			if ( this._objetos[id] )
			...
			o.x = x; o.z = z;
			this._objetos[id] = o;
			this._tabuleiro[pos2id(x, z)].objetoID = id;
...
internal class Vertice
{
	...
	public var z:int;
	public var y:int;
	public var tipo:String;		// void, grass, water, ...
	private var _suc:Array;		// lista de sucessores deste vertice
	public var objetoID:String;	// identificador do objeto contido no vertice
	
//	private var _suc:Array;		// sucessores
//	private var _obj:Array;		// Dados guardados no vertice
	
	public function Vertice( x:int, z:int, y:int = 0, tipo:String = "void" )
	{
		this.x = x;
		this.z = z;
		this.y = y;
...
//	public function addObj( id:String ):void { if ( this._obj.indexOf(id) == -1 ) this._obj.push(id); }
//	public function removeObj( id:String ):void { var index:int = 0; while ( (index = this._obj.indexOf(id)) != -1 ) this._obj.splice(index, 1); }
