...
:: Android packaging
set AND_CERT_NAME="TacticsMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TacticsMobile.p12
...
set IOS_PROVISION=cert\TacticsMobile.mobileprovision
...
set APP_ID=air.TacticsMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TacticsMobile
